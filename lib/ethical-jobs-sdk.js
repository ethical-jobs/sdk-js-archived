(function (global, factory) {
	...
	(factory((global['ethical-jobs-sdk'] = global['ethical-jobs-sdk'] || {})));
}(this, (function (exports) { 'use strict';

var index$2 = function index(str) {
...
function ApiError$1(message, error) {
  ...
  if (Error.hasOwnProperty('captureStackTrace')) {
    // V8
    Error.captureStackTrace(this, ApiError$1);
  } else {
...
if (typeof Object.setPrototypeOf === 'function') {
  Object.setPrototypeOf(ApiError$1.prototype, Error.prototype);
} else {
  ApiError$1.prototype = Object.create(Error.prototype, {
    constructor: { value: ApiError$1 }
  });
}
