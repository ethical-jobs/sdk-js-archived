...
describe('Fetch invoices endpoint', function () {
  ...
  it('should send any additional parameters', function () {
    api.fetchInvoices({ organisationId: 123, foo: 'bar', bar: 'foo' });
  ...
  it('should have the correct base endpoint', function () {
    api.fetchInvoices({ id: 22 });
    expect(api.get.args[0][0]).to.be.equal('/invoices');
  });

  it('should return the correct response', function () {
    return api.fetchInvoices().then(response => {
