...
Client.prototype.generateHttpVerbFunctions = function () {
  ...
  this.httpVerbs.forEach(function (verb) {
    _this2[verb] = function (route, params) {
      var reqUrl = _this2.formatRoute(route, verb, params);
      var reqParams = _this2.formatParameters(verb, params);
      return _this2.dispatchRequest(reqUrl, reqParams);
    };
  });
};
