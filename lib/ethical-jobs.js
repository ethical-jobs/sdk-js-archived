...
var _isomorphicUnfetch = __webpack_require__(5);
...
Client.prototype.generateHttpVerbFunctions = function () {
  ...
  this.httpVerbs.forEach(function (verb) {
    _this[verb] = function (route, params) {
      var requestUrl = _this.getDomain(_this.environment) + route;
      var requestParams = _this.formatRequestParameters(verb, params);
      return _this.dispatchRequest(requestUrl, requestParams);
    };
  });
};
...
module.exports = window.fetch = __webpack_require__(9);
